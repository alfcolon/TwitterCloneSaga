...
@objc public class TwitterAPISpacePayload: NSObject, DataSerializiingProtocol {
    ...
    enum CodingKeys: String, CodingKey, CaseIterable, ValueType {
        ...
        var valueType: TwitterAPIPayloadValue {
            switch self {
            case .id:
                return .data(.string, inArray: false)//: String?
            case .state:
                return .data(.string, inArray: false)//: String?
            case .created_at:
                return .data(.string, inArray: false)//: Date?
            case .host_ids:
                return .data(.string, inArray: false)//: [String]?
            case .lang:
                return .data(.string, inArray: false)//: String?
            case .is_ticketed:
                return .data(.string, inArray: false)//: Bool?
            case .invited_user_ids:
                return .data(.string, inArray: false)//: [String]?
            case .participant_count:
                return .data(.string, inArray: false)//: Int?
            case .scheduled_start:
                return .data(.string, inArray: false)//: Date?
            case .speaker_ids:
                return .data(.string, inArray: false)//: [String]?
